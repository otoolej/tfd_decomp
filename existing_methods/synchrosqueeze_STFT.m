...
% Started: 03-09-2021
%
% last update: Time-stamp: <2022-02-10 19:32:20 (otoolej)>
%-------------------------------------------------------------------------------
...
L_comps = N_components;
for n = 1:(N_components - 1)
    if( all((y_comps(:, end - n + 1) - y_comps(:, end - n)) == 0) )
        L_comps = L_comps - 1;
    end
end
N_components = L_comps;
y_comps = y_comps(:, 1:L_comps);
