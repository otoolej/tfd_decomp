...
set_figure(40);
pp = get(gcf, 'position');
set(gcf, 'position', [pp(1:2) 1080 560]);
...
subplot = @(n, m, p) subtightplot(n, m, p, [0.08, 0.05], [0.1, 0.04], [0.08, 0.1]); % , marg_h,marg_w);
...
if(print_)
    ...
    print2eps(['pics/two_tone_test_6methods_' tstr '_v2.eps']);
end
