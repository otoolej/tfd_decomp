...
bw = 15; fw = 15;
M = 127; bwf = 'lossless';
decomp1 = tf_decomposition(eeg1, wl, flag1, bw, fw, len1, M, bwf);
...
bw = 65; fw = 31;
M = 255; bwf = 'lossless';
decomp3a = tf_decomposition(whale1a', wl, flag1, bw, fw, len1, M, bwf);
...
bw = 65; fw = 31;
M = 255; bwf = 'lossless';
decomp3b = tf_decomposition(whale1b', wl, flag1, bw, fw, len1, M, bwf);
