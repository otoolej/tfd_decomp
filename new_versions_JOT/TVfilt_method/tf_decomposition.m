function decomp = tf_decomposition(signal1, wl, flag1, bw, fw, len1, M, bwf)
%
%
...
switch flag1
    case 0
      tfrep = estimate_tfd(signal1, wl);
      tfrep1 = tfrep;
    case 1
       tfrep = estimate_tfd(signal1(1:N-1), wl);
       tfrep1 = estimate_tfd(diff(signal1), wl); 
end
