...
% Started: 21-09-2021
%
% last update: Time-stamp: <2021-09-21 11:55:00 (otoolej)>
%-------------------------------------------------------------------------------
function y = iterative_tf_filt_JOT(x, params, N_components, N_iter, db_plot)
...
for n = 1:N_iters
    ...
    y = tv_decomposition_v1_JOT(x_residual, params, N_components, db_plot);
